...
export const DestinosZarzal = (): JSX.Element => {
  const travelImages = [
    {
      id: 1,
  ...
  return (
    <div
      className="bg-white overflow-hidden w-full min-w-[1440px] min-h-[3804px] flex"
      data-model-id="295:5538"
    >
      <div className="flex w-[1440px] h-[3809.32px] relative flex-col items-center justify-center">
        <HeaderSection />
