...
export const ServiceAsideLinks = ({ currentId }: ServiceAsideLinksProps): JSX.Element => {
  return (
    <aside className="overflow-hidden rounded-3xl border border-slate-200 bg-white shadow-[0px_18px_45px_rgba(0,0,0,0.12)]">
      ...
      <ul className="divide-y divide-slate-200">
        {SERVICES_OVERVIEW.map((service) => {
          ...
          return (
            <li key={service.id} className="bg-white transition hover:bg-slate-50">
              <Link
