...
export const DestinosBuga = (): JSX.Element => {
  ...
  return (
    <div
      className="bg-white w-full min-w-[1440px] min-h-[4072px] flex"
      data-model-id="295:4149"
    >
      <div className="flex w-[1440px] h-[4072px] relative flex-col items-center justify-center">
        <HeaderSection />
