...
export const DestinosPereira = (): JSX.Element => {
  const bannerImages = [
    {
      id: 1,
  ...
  return (
    <div
      className="bg-white w-full min-w-[1440px] min-h-[4078px] flex"
      data-model-id="295:5340"
    >
      <div className="flex w-[1440px] h-[4076.71px] relative flex-col items-center justify-center">
        <HeaderSection />
        <section
          className="relative w-[1440px] h-[150px] overflow-hidden bg-[url(/img/image-5-7.png)] bg-cover bg-[50%_50%]"
          aria-label="Pereira destination banner"
        >
